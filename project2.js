...
document.addEventListener('DOMContentLoaded', function() {
    li1.style.transition = li8.style.transition = '1.2s ease-out 5s';
    li1.style.transform = li8.style.transform = 'translateX(0%)';
    li2.style.transition = li7.style.transition = '0.9s ease-out 5s';
    li2.style.transform = li7.style.transform = 'translateX(0%)';
    li3.style.transition = li6.style.transition = '0.6s ease-in 5s';
    li3.style.transform = li6.style.transform = 'translateX(0%)';
    li4.style.transition = '0.3s ease-in 5s';
    li4.style.transform = 'translateX(0%)';
    li5.style.transition = '0.3s ease-in 5s';
